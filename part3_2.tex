...
ток делителя:
 ...
 \begin{equation}
   ...
   R_1=\dfrac{E_0-U{\text{Э}}-U{\text{БЭ}}}{I{\text{ОБ}}+I{\text{Д}}}=\dfrac{E_0-U_{\text{Э}}-U{\text{БЭ}}}{ \dfrac{I{\text{ОК}}}{ {h_21}}+I{\text{Д}} }
   \end{equation}
   \begin{equation*}
...
R_{\text{ВХ Т}}=h_11+\dfrac(1+h_21)\cdot R_{\text{ЭН}}=h_21 \cdot h_{\text{Э}}+(1+h_21) \cdot R_{\text{ЭН}}=h_11+(1+h_21) \cdot R_{\text{ЭН}}
\end{equation}
\begin{equation*}
