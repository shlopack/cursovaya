...
С_{\text{2}}=\dfrac{R_{\text{2}}+R_{\text{ВХ3}}}{2 \cdot \pi f_{\text{в}} K_{\text{ПОК}} \cdot R_2 \cdot R_{ВХ3} }=(390+51)/(2 \cdot 12000 \cdot 3.14 \cdot 631 \cdot 51 \cdot 390)=42~\text{пФ}
\end{equation}
...
K_{\text{УМ}}=\dfrac {K_{\text{Е}}}{1+K_{\text{П}}}=\dfrac {K_{\text{ВК}} \cdot K_{\text{ПОК}} \cdot K_{\text{ОК}}}{1+K_{\text{Е}}}=3.8 \cdot 631 \cdot /(1+13)=171
\end{equation}
...
U_{\text{ВХВК}}=\dfrac{U_{\text{Н}}}{K_{\text{УМ}}}=3.46/171=0.02 ~\text{В}
\end{equation}
